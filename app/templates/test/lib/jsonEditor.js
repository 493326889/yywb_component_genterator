...
//    	 this.input_type = "text";
        ...
        colorselect.type = "text";
        colorselect.className = "colorPicker";
        this.input = colorselect;
      }
      // HTML5 Input type
      else {
        this.input_type = this.format;
...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.container.classNAme = 'jsonEdit_container'
      // Edit JSON modal
      this.editjson_holder = this.theme.getModal();
      this.editjson_textarea = this.theme.getTextareaInput();
      this.editjson_textarea.style.height = '170px';
      this.editjson_textarea.style.width = '200px';
...
//    this.addproperty_list.style.paddingLeft = '5px';
		this.addproperty_list.className = 'jsonEdit_addproperty_list';
...
//    this.editor_holder.style.paddingBottom = '0';
      ...
      this.toggle_button = this.getButton('','collapse','收起');
      ...
      this.toggle_button.addEventListener('click',function(e) {
        ...
        if(self.collapsed) {
          ...
          self.setButtonText(self.toggle_button,'','collapse','收起');
        }
        else {
          self.editor_holder.style.display = 'none';
          self.collapsed = true;
          self.setButtonText(self.toggle_button,'','expand','展开');
        }
      });
      ...
      // Edit JSON Button
      this.editjson_button = this.getButton('JSON','edit','JSON编辑');
      ...
      this.addproperty_button = this.getButton('Properties','edit','对象管理');
  ...
  showEditJSON: function() {
    ...
    // TODO: edge detection
    this.editjson_holder.style.left = "10%";
...
//  control.className='jsonEdit_formControl';
...
JSONEditor.defaults.editors.array = JSONEditor.AbstractEditor.extend({
  ...
  addRow: function(value, initial) {
    ...
    if(!self.hide_delete_buttons) {
      self.rows[i].delete_button = this.getButton(self.getItemTitle(),'delete','删除 '/*+self.getItemTitle()*/);
    ...
    if(i && !self.hide_move_buttons) {
      self.rows[i].moveup_button = this.getButton('','moveup','上移');
    ...
    if(!self.hide_move_buttons) {
      self.rows[i].movedown_button = this.getButton('','movedown','下移');
  ...
  addControls: function() {
    ...
    this.toggle_button.addEventListener('click',function(e) {
      ...
      if(self.collapsed) {
        ...
        self.setButtonText(this,'','collapse','收起');
      }
      else {
        self.collapsed = true;
    ...
    this.add_row_button = this.getButton(this.getItemTitle(),'add','添加 '/*+this.getItemTitle()*/);
    ...
    this.delete_last_row_button = this.getButton('Last '+this.getItemTitle(),'delete','删除最后一项'/*+this.getItemTitle()*/);
    ...
    this.remove_all_rows_button = this.getButton('All','delete','删除全部');
...
//  el.style.boxSizing = 'border-box';
    el.className = 'jsonEdit_textArea'
    return el;
  },
...
//  el.className += ' jsonEdit_textinput'
    return el;
  },
  afterInputReady: function(input) {
  ...
  getIndentedPanel: function() {
    var el = document.createElement('div');
    el.className = 'well well-small jsonEdit_IndentedPanel';
    return el;
  },
  getFormInputDescription: function(text) {
    var el = document.createElement('p');
  ...
  getFormControl: function(label, input, description) {
    ...
    if(label && input.getAttribute('type') === 'checkbox') {
      ...
      if(label) {
        label.className += ' control-label jsonEdit_controlLabel';
...
el.className='jsonEdit_Description'
    return el;
  },
  getIndentedPanel: function() {
    var el = this._super();
